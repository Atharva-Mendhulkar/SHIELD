    ...
    <div className="mt-6">
      ...
      <div className="border border-border rounded overflow-hidden">
        <table className="w-full text-sm">
          <thead>
            <tr className="bg-secondary/50 text-slate-500 font-mono text-xs">
              <th className="text-left p-2.5 border-b border-border">Scenario</th>
              <th className="text-center p-2.5 border-b border-border">Score</th>
              <th className="text-center p-2.5 border-b border-border">Detected</th>
              <th className="text-center p-2.5 border-b border-border">Time</th>
              <th className="text-center p-2.5 border-b border-border">Result</th>
              <th className="text-center p-2.5 border-b border-border">Legacy System</th>
            </tr>
          </thead>
          <tbody>
            <AnimatePresence>
              {results.map((r, i) => (
                ...
                >
                  ...
                  <td className="p-2.5 text-center font-mono text-slate-500">{r.time}</td>
            ...
            {/* Legacy baseline row */}
            <tr className="bg-shield-red/5 border-t border-border">
              <td className="p-2.5 text-slate-500 italic">Legacy Rule-Based</td>
              <td className="p-2.5 text-center text-slate-500">N/A</td>
