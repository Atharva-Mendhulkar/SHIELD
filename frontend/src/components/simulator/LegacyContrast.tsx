...
export default function LegacyContrast({ visible, score }: LegacyContrastProps) {
  ...
  return (
    ...
    >
      {/* SHIELD Card */}
      <div className="border-2 border-shield-green rounded-lg p-6 bg-shield-green/5 shadow-[0_0_30px_rgba(0,255,136,0.1)]">
      ...
      {/* Legacy Card */}
      <div className="border-2 border-shield-red rounded-lg p-6 bg-shield-red/5 shadow-[0_0_30px_rgba(255,59,59,0.1)]">
        <div className="flex items-center gap-3 mb-4">
        ...
        <div className="text-xs font-mono space-y-1.5 text-slate-500">
          <div>Amount {'>'} INR50,000? <span className="text-shield-green">No ✓</span></div>
